...
SectionTitle("Handling cross platform env and fs");
...
// create a zero-byte file and returns the file name
...
WriteLine("Compressed file? -> {0} \n {1}",
  arg0: info.Name,
  arg1: info.Attributes.HasFlag(FileAttributes.Compressed)
);
